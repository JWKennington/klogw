...
# Inline index_string for layout
app.index_string = r"""
<!DOCTYPE html>
<html>
<head>
...
bode_graph   = dcc.Graph(id="bode-plot",    style={"width":"100%","height":"50%"}, config={"displayModeBar":False})
impulse_graph= dcc.Graph(id="impulse-plot", style={"width":"100%","height":"50%"}, config={"displayModeBar":False})
...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col(html.Div([pz_graph, pz_buttons],
                         style={"width":"100%","height":"100%","display":"flex","flexDirection":"column"}),
                md=6, style={"height":"100%"}, id="left-col"),
        dbc.Col(html.Div([bode_graph, impulse_graph],
                         style={"width":"100%","height":"100%","display":"flex","flexDirection":"column"}),
...
def unified_callback(fam, ftype, order, domain, c1, c2,
    ...
    # If shapes array => update positions
    if relayoutData and "shapes" in relayoutData:
        shapes_array = relayoutData["shapes"]
        for sdict in shapes_array:
            sname = sdict.get("name","")
    ...
    fig_pz={
        ...
        "layout":{
            ...
            "uirevision":"pz-uirev",   # <--- KEY to preserve user-drag changes
    ...
    if domain=="analog":
        shape_stable={
            ...
            "fillcolor":"rgba(0,255,0,0.07)","line":{"width":0},"layer":"below"
        }
    else:
        shape_stable={
    ...
    # poles => shape name= "pole-{pidx}-line0" / "pole-{pidx}-line1"
