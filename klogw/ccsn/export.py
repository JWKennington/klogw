# Update noise_utils.py to correct CreateREAL8TimeSeries() usage
noise_utils_lalsuite_fix = r'''
"""
...
with open('noise_utils.py', 'w') as f:
    f.write(noise_utils_lalsuite_fix)

print("noise_utils.py corrected with proper CreateREAL8TimeSeries signature.")
